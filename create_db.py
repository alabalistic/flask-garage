...
with app.app_context():
    ...
    if not User.query.filter_by(username="Анонимен").first():
        anonymous_user = User(username='Анонимен', email='anonymous@example.com', phone_number='0000000000', password="$2b$12$rO6wrQC5uuyOg/LYIUbvmOxd7KhL3qaWfITos07XbCAgREWXlF2Am", image_file='default.jpg')
